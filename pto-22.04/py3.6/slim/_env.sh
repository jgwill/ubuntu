...
export DK_TAG=jgwill/ubuntu:$UBUNTU_VER-py$PY_VER_BASE-base

export dockertag2=jgwill/ubuntu:$UBUNTU_VER-py$PY_VER_BASE-lzma-slim
export dockertag1=jgwill/ubuntu:$UBUNTU_VER-py$PY_VER_BASE-slim
export dockertag3=guillaumeai/server:ubuntu-$UBUNTU_VER-py$PY_VER_BASE-slim
export dockertag4=jgwill/ubuntu:$UBUNTU_VER-py$PY_VER-slim
export dockertag=jgwill/ubuntu:$UBUNTU_VER-py-${PY_VER}-slim

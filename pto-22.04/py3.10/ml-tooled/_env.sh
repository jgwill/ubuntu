...
. /a/src/ubuntu/pto-22.04/py$PY_VER_BASE/_env.sh|| $srcroot/ubuntu/pto-22.04/py$PY_VER_BASE/_env.sh

# The source image to build from 
export DK_TAG=jgwill/ubuntu:$UBUNTU_VER-py$PY_VER_BASE-x

export dockertag2=jgwill/ubuntu:$UBUNTU_VER-py$PY_VER_BASE-ml-lzma
export dockertag1=jgwill/ubuntu:$UBUNTU_VER-py$PY_VER_BASE-ml
export dockertag3=guillaumeai/server:ubuntu-$UBUNTU_VER-py$PY_VER_BASE-ml
export dockertag4=jgwill/ubuntu:py$PY_VER-ml
export dockertag=jgwill/ubuntu:$UBUNTU_VER-py-${PY_VER}-x-ml
